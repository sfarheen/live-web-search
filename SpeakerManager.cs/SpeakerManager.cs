...
namespace BusinessLayer
{
    public class SpeakerManager
    {
        public List<Speaker> Generatedata()
        {
            ...
            speakerlist.Add(new Speaker() { name = "Jennifer Jerome",
            ...
            speakerlist.Add(new Speaker() { name = "LaVonne L. LaRue",
            ...
            speakerlist.Add(new Speaker() { name = "Constance Olivia Smith",
            ...
            speakerlist.Add(new Speaker() { name= "Riley Rudolph Rewington",
            ...
            speakerlist.Add(new Speaker() { name = "Xhou Ta",
                                            shortname = "Xhou_Ta",
